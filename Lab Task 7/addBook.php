 ...
 <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if ($check == 5) {
        ...
        $data['Adding_Date']                =     date("Y/m/d");  
        $data['Publish_Date']                 =     $_REQUEST['publishDate'];


        if (addBooks($data)) {
              header('location:bookAddedDone.php');
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                <fieldset>
                    <legend><h1>Title :</h1></legend>
                            ...
                            <input type='text' name='title' id="title" onclick="titleVal()"><br><br>
                ...
                <fieldset>
                    <legend><h1>Author Name</h1></legend>
                        ...
                        <input type='text' name='authorname' id="authorName" onclick="authorVal()"><br><br>
                ...
                <fieldset>
                    <legend><h1>Edition</h1></legend>
                        <input type='text' name='edition' id="edition" onclick="editionVal()"><br><br>
